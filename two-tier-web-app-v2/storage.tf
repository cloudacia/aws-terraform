...
resource "aws_s3_bucket_ownership_controls" "bucket01-acl-ownership" {
...
resource "aws_s3_bucket_ownership_controls" "cloudfront-bucket-acl-ownership" {
...
resource "aws_s3_bucket_ownership_controls" "elb-bucket-acl-ownership" {
...
resource "aws_s3_bucket_acl" "acl01" {
  bucket     = aws_s3_bucket.bucket01.id
  acl        = "private"
  depends_on = [aws_s3_bucket_ownership_controls.bucket01-acl-ownership]
}
...
resource "aws_s3_bucket_acl" "acl02" {
  bucket     = aws_s3_bucket.cloudfront_bucket.id
  acl        = "private"
  depends_on = [aws_s3_bucket_ownership_controls.cloudfront-bucket-acl-ownership]
}
...
resource "aws_s3_bucket_acl" "acl03" {
  bucket     = aws_s3_bucket.elb_bucket.id
  acl        = "private"
  depends_on = [aws_s3_bucket_ownership_controls.elb-bucket-acl-ownership]
}
